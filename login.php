...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT userID, firstname, email, username FROM user WHERE username = '$username' AND password = '$password'";  
...
<aside>
  ...
  <path d="M3.35 5.47c-.18.16-.353.322-.518.487A13.134 13.134 0 0 0 1.172 8l.195.288c.335.48.83 1.12 1.465 1.755C4.121 11.332 5.881 12.5 8 12.5c.716 0 1.39-.133 2.02-.36l.77.772A7.029 7.029 0 0 1 8 13.5C3 13.5 0 8 0 8s.939-1.721 2.641-3.238l.708.709zm10.296 8.884-12-12 .708-.708 12 12-.708.708z"/>
                ...
                <p class="mt-3"><a href="loginadmin.php" >Login as Admin</a></p>

               <p>New account? Go to <a href="signup.php">Signup Center</a></p> 
...
var btn = document.getElementById("myBtn");
  ...
  modal.style.display = "block";
      ...
      setTimeout(() => {  location.replace("customer.php"); }, 1500);
...
var btn = document.getElementById("myBtn");
  ...
  modal.style.display = "block";
      ...
      let timeout = setTimeout(modal, 1000);
      setTimeout(() => {  location.replace("login.php"); }, 700);
      ...
      echo '
         <script>
            swal({
               ...
               window.location.href = "'.($select_user->rowCount() > 0 ? 'login.php' : 'register.php').'";
            });
         </script>
      ';
   }
